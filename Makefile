...
CPPFLAGS := -MMD -MP $(addprefix -I,$(INCLUDE_DIRS)) $(addprefix -I,$(LIBCUTILS_INCLUDE_PATH)) -Wl,--unresolved-symbols=ignore-in-object-files  -std=c++17 -O0 $(CPPFLAGS_WARNINGS) $(CPPFLAGS_ASAN) $(CPPFLAGS_DEBUG)
